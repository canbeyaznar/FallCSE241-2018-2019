...
{
	Rectangle::Rectangle(double width_I, double height_I): width(width_I), height(height_I),Location_X(0),Location_Y(0), color("yellow")
	{
	...
	Rectangle Rectangle::operator ++(int IgnoreMe) //Postfix version
	{
		...
		return Rectangle(*this,temp1,temp2);
