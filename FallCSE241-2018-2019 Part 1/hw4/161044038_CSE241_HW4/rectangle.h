...
namespace Shapes_namespace
{
	...
	{
		public:
			Rectangle(): width(0), height(0),Location_X(0),Location_Y(0), color("yellow"),perimeterOfShape(0), areaOfShape(0){/*default constructor*/}
			Rectangle(double width_I, double height_I);
			Rectangle(const Rectangle tempRectangle, double locX, double locY){*this=tempRectangle; Location_X=locX; Location_Y=locY;	}
